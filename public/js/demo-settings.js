    ...
    return function e(r) {
        ...
        function a(e, t, a) {
            if ("undefined" != typeof document) {
                "number" == typeof (a = d({
                    path: "/"
                }, s.defaults, a)).expires && (a.expires = new Date(+new Date + 864e5 * a.expires)),
                a.expires = a.expires ? a.expires.toUTCString() : "";
                try {
                    var o = JSON.stringify(t);
                    /^[\{\[]/.test(o) && (t = o)
                } catch (e) {}
                t = r.write ? r.write(t, e) : encodeURIComponent(String(t)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent),
...
function(s, d) {
    ...
    s.Demo = {
        ...
        locked: function(e) {
            !0 === e ? (d(v + "[data-key=aside]").add(v + "[data-key=header]").add(v + "[data-key=skin]").addClass("disabled"),
            s.Demo.update("skin", "default", !0),
            d(v + "[data-key=skin]").removeClass("active"),
            d(v + "[data-key=skin][data-update=default]").addClass("active")) : d(v + "[data-key=aside]").add(v + "[data-key=header]").add(v + "[data-key=skin]").removeClass("disabled")
        },
        apply: function() {
            s.Demo.apps();
            for (var e = 0, t = n; e < t.length; e++) {
                var a, o, i = t[e];
                "aside" !== i && "navside" !== i && "style" !== i || (a = s.Demo.defs(i),
                d(o = "aside" === i ? m : "navside" === i ? c : r).removeClass(s.Demo.style("all", i)),
        ...
        update: function(e, t, a) {
            var o, i = s.Demo.style(t, e), n = s.Demo.style("all", e);
            s.Demo.apps();
            "aside" !== e && "navside" !== e || (d(o = "navside" == e ? c : m).removeClass(n),
            d(o).addClass(i)),
            "mode" === e && (r.removeClass(n).removeAttr("theme"),
            i === p ? (r.addClass(i).attr("theme", "dark"),
            s.Demo.locked(!0)) : (r.addClass(i).removeAttr("theme"),
            s.Demo.locked(!1))),
            "style" === e && (r.removeClass(n),
            r.addClass(i)),
            "skin" === e && (o = s.Demo.skins(i),
            n = d("#skin-default").attr("href").replace("theme", "skins/" + o),
            "theme" === o ? d(u).remove() : 0 < d(u).length ? d(u).attr("href", n) : l.append('<link id="skin-theme" rel="stylesheet" href="' + n + '">')),
            !0 === a && s.Demo.save(e, t)
        },
        reset: function() {
            var t = s.Demo.apps();
            ...
            for (var e = 0, a = n; e < a.length; e++) {
                ...
                d("[data-key='" + o + "']").each(function() {
                    ...
                    "aside" !== o && "navside" !== o && "style" !== o || e === h[t][o] && d(this).addClass("active"),
                    "mode" !== o && "skin" !== o || e !== i && "default" !== e || d(this).addClass("active")
                }),
                s.Demo.remove(o)
            }
        ...
        load: function() {
            s.Demo.apply(),
            0 < d(v).length && d(v).each(function() {
                var e = d(this).data("update")
                  , t = d(this).data("key");
                "aside" !== t && "navside" !== t && "style" !== t || e === s.Demo.defs(t) && (d(this).parent(y).find(v).removeClass("active"),
                d(this).addClass("active")),
                "mode" !== t && "skin" !== t && "dir" !== t || e != s.Demo.current("skin") && e != s.Demo.current("mode") && e != s.Demo.current("dir") || (d(this).parent(y).find(v).removeClass("active"),
                d(this).addClass("active"))
            })
        },
        trigger: function() {
