...
!function(p, x) {
    ...
    p.CurrentLink = function() {
        ...
        x(".nk-menu-link, .menu-link, .nav-link").each(function() {
            ...
            x("[data-target=" + t + "]").parent().addClass("active")) : e.closest("li").removeClass("active current-page").parents().closest("li:not(.current-page)").removeClass("active")
        })
    }
    ,
    ...
    p.TGL.content = function(e, t) {
        ...
        l.on("mouseup", function(e) {
            ...
            o = x(".modal"),
            t.is(e.target) || 0 !== t.has(e.target).length || n.is(e.target) || 0 !== n.has(e.target).length || 0 !== x(e.target).closest(".select2-container").length || a.is(e.target) || 0 !== a.has(e.target).length || i.is(e.target) || 0 !== i.has(e.target).length || o.is(e.target) || 0 !== o.has(e.target).length || (p.Toggle.removed(t.data("target"), r),
            s = !1))
        }),
        c.on("resize", function() {
            n.each(function() {
    ...
    p.TGL.ddmenu = function(e, t) {
        var e = e || ".nk-menu-toggle"
          ...
          , a = t ? f(n, t) : n;
        x(e).on("click", function(e) {
            (p.Win.width < u.lg || x(this).parents().hasClass(d)) && p.Toggle.dropMenu(x(this), a),
            e.preventDefault()
        })
    }
    ,
    ...
    p.Tagify = function(e, t) {
        x(e).exists() && "function" == typeof x.fn.tagify && (t = t ? f(void 0, t) : void 0,
        x(e).tagify(t))
    }
    ,
